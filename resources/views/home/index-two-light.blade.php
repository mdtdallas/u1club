                    ...
                    <div class="tab-content mt-50" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="dream" role="tabpanel"
                            ...
                            <div class="row mb-none-30">
                                ...
                                @if (isset($message))
                                    <x-check-my-numbers :message="$message" />
                                @else
                                    <x-check-my-numbers />
                                @endif
                                ...
                                <div class="col-lg-8 mb-30">
                                    ...
                                    <div class="btn-grp">
                                        <a href="winner.html" class="btn-border">browse more electronics</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="bike" role="tabpanel" aria-labelledby="bike-tab">
                            <div class="row mb-none-30">
                                ...
                                <div class="col-lg-8 mb-30">
                                    ...
                                    <div class="btn-grp">
                                        <a href="winner.html" class="btn-border">browse more adventure</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="laptop" role="tabpanel" aria-labelledby="laptop-tab">
                            <div class="row mb-none-30">
                                ...
                                <div class="col-lg-8 mb-30">
                                    ...
                                    <div class="btn-grp">
                                        <a href="winner.html" class="btn-border">browse more luxury</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="support-card">
                        ...
                        <div class="support-card__content">
                            ...
                            <div class="btn-grp justify-content-xl-start mt-3">
                                ...
                                <a href="mailto:mdtdallas@hotmail.com"
                                    class="cmn-btn btn-sm text-capitalize">Email us
